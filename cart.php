...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row g-3">
            ...
            <?php
            $sql =  "SELECT * FROM `orders` WHERE UserID ='$UserID' AND `payment`='pending'";
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 ">
                                            ...
                                            <span><strong><?php echo $price ?> BDT</strong></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-6 d-flex justify-content-center align-items-center">
                                    <a href="checkout.php?price=<?php echo $price ?>&OrderID=<?php echo $OrderID ?>" class="btn btn-dark btn-sm px-3">
                                        Checkout Now
